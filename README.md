...
| [download_cmems_sss.py](download_cmems_sss.py) | Copernicus Marine L4 海表盐度与密度 | 1993 起，日期区间 | 逐日或逐月，按源和年份保存 | [CMEMS SSS/SSD](docs/cmems_sss.md) |
...
| GLORYS、DUACS、CMEMS SSS/SSD | Copernicus Marine 账号，运行 `copernicusmarine login` |
| ERA5 | CDS 账号、数据集条款及 `.cdsapirc`，见 [ERA5 文档](docs/era5_flux.md) |
| SCSORA、Argo、CCI、CCMP | 脚本使用公开下载入口；使用许可与引用见各文档 |

## 区域与恢复

- GLORYS、DUACS、CCI、CCMP、ERA5 默认 `105 125 0 25`；CMEMS SSS/SSD 默认西北太平洋 `100 180 0 60`。这些脚本都使用空格分隔的 `--bbox 西 东 南 北`。
